...
async function crawlChinese(url,n){
    url = "http://ccll.cau.ac.kr/dm/dm_1.php";
    if(n == 2){
        url = "http://ccll.cau.ac.kr/dm/dm_1.php?idx=&p_idx=&s_kind=&s_scroll=all&s_key=&p_page=2&code=b_2&p_listtype=&p_mode=list&mode=&p_pgfile=%2Fdm%2Fdm_1.php";
    }
    let url_list = [];
    let title_list = [];

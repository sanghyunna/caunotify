...
class ShortCrypt {
    ...
    decryptURLComponent(urlComponent) {
        ...
        try {
            const encrypted = rfc4648_1.base64url.parse(encryptedBase64Url, { out: Uint8Array, loose: true });
    ...
    encryptToQRCodeAlphanumeric(data) {
        ...
        const encrypted = cipher.body;
        const baseChar = String.fromCharCode(base);
        const result = rfc4648_1.base32.stringify(encrypted, { pad: false });
        const resultArray = new TextEncoder().encode(result);
        const len = resultArray.length;
        let sum = long_1.default.fromNumber(base, true);
        resultArray.forEach((n) => {
    ...
    decryptQRCodeAlphanumeric(qrCodeAlphanumeric) {
        ...
        try {
            const encrypted = rfc4648_1.base32.parse(encryptedBase32, { out: Uint8Array, loose: true });
            return this.decrypt(base, encrypted);
        }
        catch {
            return false;
